...
The script [extract-osx-sdk.sh](https://github.com/polarisnetwork-project/polarisnetwork/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
polarisnetwork/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/polarisnetwork-project/polarisnetwork/blob/master/doc/README_osx.md) for troubleshooting tips.
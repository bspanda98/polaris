...
The build script we'll be using is contained in the POLARISNETWORK github repository ([contrib/gitian-build.py](https://github.com/polarisnetwork-project/polarisnetwork/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the POLARISNETWORK repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/POLARISNETWORK-Project/POLARISNETWORK/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, polarisnetwork-detached-sigs, and polarisnetwork GitHub repos.

...
class RawTransactionsTest(polarisnetworkTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid polarisnetwork address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid polarisnetwork address" in e.error['message'])

...
from test_framework.polarisnetwork_node import polarisnetworkTestNode
...
class POLARISNETWORK_ColdStakingTest(polarisnetworkTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(polarisnetworkTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 POL from the pot)
...
if __name__ == '__main__':
    POLARISNETWORK_ColdStakingTest().main()

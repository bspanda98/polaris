...
def main():
    ...
    # Filter out hosts with multiple polarisnetwork ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple polarisnetwork ports' % (ip_stats(ips)), file=sys.stderr)

...
extern UniValue setzpolseed(const UniValue& params, bool fHelp);
extern UniValue getzpolseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpol(const UniValue& params, bool fHelp);
extern UniValue dzpolstate(const UniValue& params, bool fHelp);

...
#include "qt/polarisnetwork/forms/ui_coldstakingwidget.h"
#include "qt/polarisnetwork/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/polarisnetwork/requestdialog.h"
#include "qt/polarisnetwork/tooltipmenu.h"
#include "qt/polarisnetwork/furlistrow.h"
...
#include "qt/polarisnetwork/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(POLARISNETWORKGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", tr("Select POL outputs to delegate."));
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 POL" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}

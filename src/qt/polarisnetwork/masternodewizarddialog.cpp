...
#include "qt/polarisnetwork/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/polarisnetwork/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ...
        ui->lineEditPort->setText("2997");
    } else {
        ui->lineEditPort->setText("1997");
    }

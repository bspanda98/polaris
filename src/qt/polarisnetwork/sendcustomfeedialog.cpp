...
#include "qt/polarisnetwork/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(POLARISNETWORKGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &POLARISNETWORKGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

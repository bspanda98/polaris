...
#include <QWidget>
#include <QString>
#include "qt/polarisnetwork/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(POLARISNETWORKGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    POLARISNETWORKGUI* getWindow() { return this->window; }
...
protected:
    POLARISNETWORKGUI* window = nullptr;

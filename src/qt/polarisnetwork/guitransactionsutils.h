...
#ifndef FURSZY_POLARISNETWORK_GUITRANSACTIONSUTILS_H
#define FURSZY_POLARISNETWORK_GUITRANSACTIONSUTILS_H
...
#endif //FURSZY_POLARISNETWORK_GUITRANSACTIONSUTILS_H

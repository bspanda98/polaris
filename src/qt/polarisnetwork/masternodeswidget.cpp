...
#include "qt/polarisnetwork/forms/ui_masternodeswidget.h"

#include "qt/polarisnetwork/qtutils.h"
#include "qt/polarisnetwork/mnrow.h"
#include "qt/polarisnetwork/mninfodialog.h"
#include "qt/polarisnetwork/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(POLARISNETWORKGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 10000)) {
        inform(tr("Not enough balance to create a masternode, 10,000 POL required."));
        return;
    }
    showHideOp(true);

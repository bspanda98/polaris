...
#include "qt/polarisnetwork/contactsdropdown.h"
#include "qt/polarisnetwork/sendmultirow.h"
#include "qt/polarisnetwork/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(POLARISNETWORKGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onPOLSelected(bool _isPOL);
    void onSendClicked();
...
private:
    ...
    bool sendZpol(QList<SendCoinsRecipient> recipients);

...
#include "qt/polarisnetwork/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/polarisnetwork/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(POLARISNETWORKGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to POLARISNETWORKGUI::handleRestart()

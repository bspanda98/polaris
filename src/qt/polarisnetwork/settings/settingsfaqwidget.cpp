...
#include "qt/polarisnetwork/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/polarisnetwork/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(POLARISNETWORKGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &POLARISNETWORKGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

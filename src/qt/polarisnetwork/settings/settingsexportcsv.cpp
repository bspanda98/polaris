...
#include "qt/polarisnetwork/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(POLARISNETWORKGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("POLARISNETWORK_tx_csv_export(*.csv)") : tr("POLARISNETWORK_addresses_csv_export(*.csv)"),
                                        nullptr);

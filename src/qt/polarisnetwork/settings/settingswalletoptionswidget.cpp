...
#include "qt/polarisnetwork/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/polarisnetwork/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(POLARISNETWORKGUI* _window, QWidget *parent) :

...
#include "qt/polarisnetwork/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(POLARISNETWORKGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &POLARISNETWORKGUI::openFAQ);

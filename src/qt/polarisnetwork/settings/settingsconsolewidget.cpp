...
#include "qt/polarisnetwork/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/polarisnetwork/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(POLARISNETWORKGUI* _window, QWidget *parent) :

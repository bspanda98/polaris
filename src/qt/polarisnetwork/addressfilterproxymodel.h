...
#ifndef POLARISNETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define POLARISNETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //POLARISNETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

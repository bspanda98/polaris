...
#include "config/polarisnetwork-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalpol = 0;
    qint64 totalZpol = 0;
    QList<qreal> valuespol;
    QList<qreal> valueszpol;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(POLARISNETWORKGUI* _window);
    ~DashboardWidget();

...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizepolarisnetworkAmount") || reset)
        SoftSetArg("-anonymizepolarisnetworkamount", settings.value("nAnonymizepolarisnetworkAmount").toString().toStdString());

...
#ifndef POLARISNETWORK_QT_WALLETMODEL_H
#define POLARISNETWORK_QT_WALLETMODEL_H
...
/** Interface to POLARISNETWORK wallet from Qt view code. */
...
#endif // POLARISNETWORK_QT_WALLETMODEL_H

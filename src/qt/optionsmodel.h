...
/** Interface from Qt to configuration data structure for POLARISNETWORK client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizepolarisnetworkAmount, //int
...
Q_SIGNALS:
    ...
    void anonymizepolarisnetworkAmountChanged(int);

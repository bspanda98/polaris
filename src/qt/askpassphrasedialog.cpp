...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                " <b>" + tr("LOSE ALL OF YOUR POL") + "</b>!<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            newpassCache = newpass1;
            POLARISNETWORKGUI* window = static_cast<POLARISNETWORKGUI*>(parentWidget());
...
{
    POLARISNETWORKGUI* gui = static_cast<POLARISNETWORKGUI*>(parentWidget());
...
{
    hide();
    static_cast<POLARISNETWORKGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +

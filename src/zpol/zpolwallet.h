...
#ifndef POLARISNETWORK_ZPOLWALLET_H
#define POLARISNETWORK_ZPOLWALLET_H
...
public:
    ...
    void GenerateDeterministicZPOL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZPOL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //POLARISNETWORK_ZPOLWALLET_H

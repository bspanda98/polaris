...
#ifndef POLARISNETWORK_LEGACY_ZPOS_H
#define POLARISNETWORK_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZpolStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZpolStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZPOL() const override { return true; }
...
#endif //POLARISNETWORK_LEGACY_ZPOS_H

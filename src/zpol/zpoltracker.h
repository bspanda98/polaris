...
#ifndef POLARISNETWORK_ZPOLTRACKER_H
#define POLARISNETWORK_ZPOLTRACKER_H
...
public:
    CzPOLTracker(CWallet* parent);
    ~CzPOLTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzPOLWallet* zPOLWallet = NULL);
...
#endif //POLARISNETWORK_ZPOLTRACKER_H

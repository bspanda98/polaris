 ...
 *     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d01043a446f6e277420776f726b20666f72207765656b656e64732c20776f726b20666f72206f757220676f616c73202d2031382f4a616e2f323031382e)
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1589792697, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1517542208, 2402015, 0x1f3fffff, 1, 250 * COIN);
...
if(genesis.GetHash() != uint256("0x"))
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000d243f7f1781b02d7cc463ebdb798aa00741018774f794fc5d53a605f33e"));
        assert(genesis.hashMerkleRoot == uint256S("0x77fc7d6cfbc4ec91703444a515955092d4b7c04dbb8f23be59deb42a39ec0057"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // POLARISNETWORK starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.npolarisnetworkBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.npolarisnetworkBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "polarisnetwork.seed.fuzzbawls.pw", true));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "polarisnetwork.seed2.fuzzbawls.pw", true));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.npolarisnetworkBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.npolarisnetworkBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "polarisnetwork-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "polarisnetwork-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet polarisnetwork addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet polarisnetwork script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet polarisnetwork BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet polarisnetwork BIP32 prvkeys start with 'DRKP'

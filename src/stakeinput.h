...
#ifndef POLARISNETWORK_STAKEINPUT_H
#define POLARISNETWORK_STAKEINPUT_H
...
public:
    ...
    bool IsZPOL() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //POLARISNETWORK_STAKEINPUT_H
